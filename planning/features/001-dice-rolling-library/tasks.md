...
**Input**: Design documents from `planning/features/001-dice-rolling-library/`  
...
- [x] T030 [P] Update `README.md`: add "RNG Injection" subsection under Debug Logging with a seeded roll example, a mock testing example, and the `--seed` CLI example from `planning/features/001-dice-rolling-library/quickstart.md`
